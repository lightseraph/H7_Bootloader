...
//�û�������
// SDMMCʱ�Ӽ��㹫ʽ:SDMMC_CKʱ��=sdmmc_ker_ck/[2*clkdiv];����,sdmmc_ker_ck����pll1_q_ck,Ϊ200Mhz
//���������������,�볢�Խ�SDMMC_TRANSFER_CLK_DIVƵ�ʽ���
//#define SDMMC_INIT_CLK_DIV        0xFA		//SDMMC��ʼ��Ƶ�ʣ�200M/(250*2)=400Khz,���400Kh
#define SDMMC_TRANSFER_CLK_DIV 0x04 // SDMMC����Ƶ��,��ֵ̫С���ܻᵼ�¶�д�ļ�����
...
u8 SD_ReadDisk(u8 *buf, u32 sector, u32 cnt);  //��SD��,fatfs/usb����
u8 SD_WriteDisk(u8 *buf, u32 sector, u32 cnt); //дSD��,fatfs/usb����
